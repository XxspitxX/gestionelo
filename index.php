...
require_once '2_Model/index_menu.php';
/*---------------- PHP Custom Scripts ---------
		...
		?>
				...
				<header id="header">
					...
					<div class="project-context hidden-xs">
						...
						<label class="select">
							<select Id= "lstrEmpresaMaster" class="input-sm">
							</select> 
							<i></i> 
						</label>
						<!-- end dropdown-menu-->
					...
					<div class="pull-right">
						...
						<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
							<li class="">
								<a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown"> 
									<img src="<?php echo ASSETS_URL; ?>/img/avatars/sunny.png" alt="" class="online" />
								</a>
								<ul class="dropdown-menu pull-right">
									...
									<li class="divider"></li>
									<li>
										<a href="1_view/login.php" class="padding-10 padding-top-5 padding-bottom-5" data-action="userLogout"><i class="fa fa-sign-out fa-lg"></i> <strong><u>L</u>ogout</strong></a>
									</li>
								</ul>
							</li>
						</ul>
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a href="<?php echo APP_URL; ?>/1_view/login.php" title="Sign Out" data-action="userLogout" data-logout-msg="Seguro que desea salir del sistema?"><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->
...
<div id="main" role="main">
	...
	<!-- MAIN CONTENT -->
    <!-- <form id="masterForm" novalidate="novalidate" enctype="multipart/form-data">  -->
	<div id="content">
...
<script src="<?php echo ASSETS_URL; ?>/4_Utils/Utils.js?v=8"></script>	
<script src="<?php echo ASSETS_URL; ?>/1_view/index_view.js?v=3"> </script>


<script>
//Cargue de empresas
   fn_lstrEmpresaMaster_load();

	$("#lstrEmpresaMaster").change(function () {
			var x = $(this);
			fn_cambiarMenuMaster_ajax(x.val());
     });  
</script>
